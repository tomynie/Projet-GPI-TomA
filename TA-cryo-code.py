...
def save_and_show(fig, filename, results_dir, pause=False):
    """Sauvegarde la figure dans results/. Affiche seulement si pause=True."""
...
def extract_particles(img_final, pics_orientes, carte_max_ncc, carte_angles,
    ...
    # on trie par score NCC decroissant et on affiche TOUTES les particules
    ...
    # normaliser axes en tableau 2D dans tous les cas
...
def generate_report(args, image_2d, img_final, structure, template_pour_ncc,
    ...
    """Genere un fichier rapport.txt avec toutes les donnees calculees."""
